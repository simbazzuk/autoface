...
export default function ConnectionPage(){
 ...
 return <main>
  <section className="page-hero compact-hero"><div className="container">
   <span className="eyebrow">Connection · v0.10</span><h1>Your introduction with {o.firstName}.</h1>
  ...
  <section className="section connection-section"><div className="container connection-layout">
   <div className="connection-main">
    ...
    <div className="card connection-summary">
     ...
     <div className="connection-scores"><span><b>{o.authenticityScore}%</b><small>Authenticity</small></span><span><b>{o.compatibilityScore}%</b><small>Compatibility</small></span></div>
    </div>
    ...
    <div className="card starter-card"><span className="privacy-kicker">CONVERSATION STARTER</span><h2>Need somewhere to start?</h2><blockquote>“{data.conversationStarter}”</blockquote><a className="btn btn-primary" href={`/messages/${matchId}`}>Open conversation</a></div>
   </div>
