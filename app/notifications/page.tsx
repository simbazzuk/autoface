...
export default function NotificationsPage(){
 ...
 return <main><section className="page-hero compact-hero"><div className="container notification-head"><div><span className="eyebrow">Activity</span><h1>What’s happening in AutoFace.</h1><p className="lead">Introductions, messages, connection activity and important trust events appear here.</p></div>{items.some(x=>!x.read)&&<button className="btn" onClick={()=>void mark(undefined,true)}>Mark all as read</button>}</div></section>
