...
export default function EarlyAccess(){
 ...
 return <main><section className="page-hero"><div className="container"><span className="eyebrow">Early access</span><h1>Help shape AutoFace.</h1><p className="lead">AutoFace is preparing a small controlled beta. Register your interest for future invitation rounds.</p></div></section><section className="section"><div className="container">
   <form className="form" onSubmit={submit}>
     ...
     {status==="done"&&<p className="notice" style={{marginTop:16}}>Thanks — your interest has been captured.</p>}
     {status==="error"&&<p className="notice" style={{marginTop:16}}>Something went wrong. Please try again.</p>}
     <p className="muted" style={{fontSize:13}}>Joining the list does not guarantee beta access. Invitations can be released gradually while the service is tested.</p>
   </form>
 </div></section></main>
}
