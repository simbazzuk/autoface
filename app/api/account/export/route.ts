...
export async function GET(request: Request) {
  try {
    ...
    const [
      ...
      adminDb.collection("notificationPreferences").doc(uid).get(),
    ...
    const exportData = {
      ...
      notificationPreferences: notificationPreferences.exists ? serialise(notificationPreferences.data()) : null,
      profilePhotoMetadata: profilePhoto.exists ? serialise(profilePhoto.data()) : null,
      notifications,
